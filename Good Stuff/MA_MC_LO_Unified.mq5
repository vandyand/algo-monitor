...
int ma_period2_1 = ma_period1_1;
int ma_period3_1 = ma_period1_1;
int ma_period4_1 = ma_period1_1;
int ma_period5_1 = ma_period1_1;
int ma_period6_1 = ma_period1_1;
int ma_period7_1 = ma_period1_1;
...
*/      
      ...
      if(CurrentOpenPositions(magic1_) >= 1 && barNum - openBar1 >= th1){
      ...
      if(CurrentOpenPositions(magic2_) >= 1 && barNum - openBar2 >= th2){
      ...
      if(CurrentOpenPositions(magic3_) >= 1 && barNum - openBar3 >= th3){
      ...
      if(CurrentOpenPositions(magic4_) >= 1 && barNum - openBar4 >= th4){
      ...
      if(CurrentOpenPositions(magic5_) >= 1 && barNum - openBar5 >= th5){
      ...
      if(CurrentOpenPositions(magic6_) >= 1 && barNum - openBar6 >= th6){
      ...
      if(CurrentOpenPositions(magic7_) >= 1 && barNum - openBar7 >= th7){
...
bool BuyAsync(double volume, int magicNum, string symbol, double tp, double sl){
   ...
   if(quote=="JPY"){
      takeprofit = NormalizeDouble(tp * 100,2);
      stoploss = NormalizeDouble(sl * 100,2);
   }
   ...
   req.sl          =req.price - stoploss;
   req.tp          =req.price + takeprofit;
...
bool SellAsync(double volume, int magicNum, string symbol, double tp, double sl){
