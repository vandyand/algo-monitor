...
string symbols[8] = {"EURUSD","AUDUSD","USDJPY","GBPUSD","USDCHF","USDCAD","NZDUSD","BTCUSD"};

int OnInit(){

   maHandle1_1 = iMA(symbols[7],_Period,ma_period1_1,0,MODE_SMA,PRICE_OPEN);
   maHandle1_2 = iMA(symbols[7],_Period,ma_period1_2,0,MODE_SMA,PRICE_OPEN);
   maHandle1_3 = iMA(symbols[7],_Period,ma_period1_3,0,MODE_SMA,PRICE_OPEN);
   maHandle1_4 = iMA(symbols[7],_Period,ma_period1_4,0,MODE_SMA,PRICE_OPEN);
   maHandle1_5 = iMA(symbols[7],_Period,ma_period1_5,0,MODE_SMA,PRICE_OPEN);
   maHandle1_6 = iMA(symbols[7],_Period,ma_period1_6,0,MODE_SMA,PRICE_OPEN);
   maHandle1_7 = iMA(symbols[7],_Period,ma_period1_7,0,MODE_SMA,PRICE_OPEN);
   maHandle1_8 = iMA(symbols[7],_Period,ma_period1_8,0,MODE_SMA,PRICE_OPEN);
  
   maHandle2_1 = iMA(symbols[7],_Period,ma_period2_1,0,MODE_SMA,PRICE_OPEN);
   maHandle2_2 = iMA(symbols[7],_Period,ma_period2_2,0,MODE_SMA,PRICE_OPEN);
   maHandle2_3 = iMA(symbols[7],_Period,ma_period2_3,0,MODE_SMA,PRICE_OPEN);
   maHandle2_4 = iMA(symbols[7],_Period,ma_period2_4,0,MODE_SMA,PRICE_OPEN);
   maHandle2_5 = iMA(symbols[7],_Period,ma_period2_5,0,MODE_SMA,PRICE_OPEN);
   maHandle2_6 = iMA(symbols[7],_Period,ma_period2_6,0,MODE_SMA,PRICE_OPEN);
   maHandle2_7 = iMA(symbols[7],_Period,ma_period2_7,0,MODE_SMA,PRICE_OPEN);
   maHandle2_8 = iMA(symbols[7],_Period,ma_period2_8,0,MODE_SMA,PRICE_OPEN);

   maHandle3_1 = iMA(symbols[7],_Period,ma_period3_1,0,MODE_SMA,PRICE_OPEN);
   maHandle3_2 = iMA(symbols[7],_Period,ma_period3_2,0,MODE_SMA,PRICE_OPEN);
   maHandle3_3 = iMA(symbols[7],_Period,ma_period3_3,0,MODE_SMA,PRICE_OPEN);
   maHandle3_4 = iMA(symbols[7],_Period,ma_period3_4,0,MODE_SMA,PRICE_OPEN);
   maHandle3_5 = iMA(symbols[7],_Period,ma_period3_5,0,MODE_SMA,PRICE_OPEN);
   maHandle3_6 = iMA(symbols[7],_Period,ma_period3_6,0,MODE_SMA,PRICE_OPEN);
   maHandle3_7 = iMA(symbols[7],_Period,ma_period3_7,0,MODE_SMA,PRICE_OPEN);
   maHandle3_8 = iMA(symbols[7],_Period,ma_period3_8,0,MODE_SMA,PRICE_OPEN);

   maHandle4_1 = iMA(symbols[7],_Period,ma_period4_1,0,MODE_SMA,PRICE_OPEN);
   maHandle4_2 = iMA(symbols[7],_Period,ma_period4_2,0,MODE_SMA,PRICE_OPEN);
   maHandle4_3 = iMA(symbols[7],_Period,ma_period4_3,0,MODE_SMA,PRICE_OPEN);
   maHandle4_4 = iMA(symbols[7],_Period,ma_period4_4,0,MODE_SMA,PRICE_OPEN);
   maHandle4_5 = iMA(symbols[7],_Period,ma_period4_5,0,MODE_SMA,PRICE_OPEN);
   maHandle4_6 = iMA(symbols[7],_Period,ma_period4_6,0,MODE_SMA,PRICE_OPEN);
   maHandle4_7 = iMA(symbols[7],_Period,ma_period4_7,0,MODE_SMA,PRICE_OPEN);
   maHandle4_8 = iMA(symbols[7],_Period,ma_period4_8,0,MODE_SMA,PRICE_OPEN);

   maHandle5_1 = iMA(symbols[7],_Period,ma_period5_1,0,MODE_SMA,PRICE_OPEN);
   maHandle5_2 = iMA(symbols[7],_Period,ma_period5_2,0,MODE_SMA,PRICE_OPEN);
   maHandle5_3 = iMA(symbols[7],_Period,ma_period5_3,0,MODE_SMA,PRICE_OPEN);
   maHandle5_4 = iMA(symbols[7],_Period,ma_period5_4,0,MODE_SMA,PRICE_OPEN);
   maHandle5_5 = iMA(symbols[7],_Period,ma_period5_5,0,MODE_SMA,PRICE_OPEN);
   maHandle5_6 = iMA(symbols[7],_Period,ma_period5_6,0,MODE_SMA,PRICE_OPEN);
   maHandle5_7 = iMA(symbols[7],_Period,ma_period5_7,0,MODE_SMA,PRICE_OPEN);
   maHandle5_8 = iMA(symbols[7],_Period,ma_period5_8,0,MODE_SMA,PRICE_OPEN);

   maHandle6_1 = iMA(symbols[7],_Period,ma_period6_1,0,MODE_SMA,PRICE_OPEN);
   maHandle6_2 = iMA(symbols[7],_Period,ma_period6_2,0,MODE_SMA,PRICE_OPEN);
   maHandle6_3 = iMA(symbols[7],_Period,ma_period6_3,0,MODE_SMA,PRICE_OPEN);
   maHandle6_4 = iMA(symbols[7],_Period,ma_period6_4,0,MODE_SMA,PRICE_OPEN);
   maHandle6_5 = iMA(symbols[7],_Period,ma_period6_5,0,MODE_SMA,PRICE_OPEN);
   maHandle6_6 = iMA(symbols[7],_Period,ma_period6_6,0,MODE_SMA,PRICE_OPEN);
   maHandle6_7 = iMA(symbols[7],_Period,ma_period6_7,0,MODE_SMA,PRICE_OPEN);
   maHandle6_8 = iMA(symbols[7],_Period,ma_period6_8,0,MODE_SMA,PRICE_OPEN);

   maHandle7_1 = iMA(symbols[7],_Period,ma_period7_1,0,MODE_SMA,PRICE_OPEN);
   maHandle7_2 = iMA(symbols[7],_Period,ma_period7_2,0,MODE_SMA,PRICE_OPEN);
   maHandle7_3 = iMA(symbols[7],_Period,ma_period7_3,0,MODE_SMA,PRICE_OPEN);
   maHandle7_4 = iMA(symbols[7],_Period,ma_period7_4,0,MODE_SMA,PRICE_OPEN);
   maHandle7_5 = iMA(symbols[7],_Period,ma_period7_5,0,MODE_SMA,PRICE_OPEN);
   maHandle7_6 = iMA(symbols[7],_Period,ma_period7_6,0,MODE_SMA,PRICE_OPEN);
   maHandle7_7 = iMA(symbols[7],_Period,ma_period7_7,0,MODE_SMA,PRICE_OPEN);
   maHandle7_8 = iMA(symbols[7],_Period,ma_period7_8,0,MODE_SMA,PRICE_OPEN);
   ...
   if(Find_New_Bar()){
      ...
      if(CurrentOpenPositions(magic1_) < 1){
         if(EnterLongSignal1_ && !EnterShortSignal1_ && !ExitLongSignal1_){
            if(!BuyAsync(Lots,magic1_,symbols[0])){Alert("Error entering long ",symbols[0],". Last error: ",GetLastError());}
      ...
      if(CurrentOpenPositions(magic3_) < 1){
         if(EnterLongSignal3_ && !EnterShortSignal3_ && !ExitLongSignal3_){
            if(!BuyAsync(Lots,magic3_,symbols[2])){Alert("Error entering long ",symbols[2],". Last error: ",GetLastError());}
            //while(!BuyAsync(Lots,symbols[0])){Sleep(100);}
            longPos3_ = true;
         }
      ...
      if(CurrentOpenPositions(magic4_) < 1){
         if(EnterLongSignal4_ && !EnterShortSignal4_ && !ExitLongSignal4_){
            if(!BuyAsync(Lots,magic4_,symbols[3])){Alert("Error entering long ",symbols[2],". Last error: ",GetLastError());}
            //while(!BuyAsync(Lots,symbols[0])){Sleep(100);}
            longPos4_ = true;
         }
      ...
      if(CurrentOpenPositions(magic5_) < 1){
         if(EnterLongSignal5_ && !EnterShortSignal5_ && !ExitLongSignal5_){
            if(!BuyAsync(Lots,magic5_,symbols[4])){Alert("Error entering long ",symbols[2],". Last error: ",GetLastError());}
            //while(!BuyAsync(Lots,symbols[0])){Sleep(100);}
            longPos5_ = true;
         }
      ...
      if(CurrentOpenPositions(magic6_) < 1){
         if(EnterLongSignal6_ && !EnterShortSignal6_ && !ExitLongSignal6_){
            if(!BuyAsync(Lots,magic6_,symbols[5])){Alert("Error entering long ",symbols[2],". Last error: ",GetLastError());}
            //while(!BuyAsync(Lots,symbols[0])){Sleep(100);}
            longPos6_ = true;
         }
      ...
      if(CurrentOpenPositions(magic7_) < 1){
         if(EnterLongSignal7_ && !EnterShortSignal7_ && !ExitLongSignal7_){
            if(!BuyAsync(Lots,magic7_,symbols[6])){Alert("Error entering long ",symbols[2],". Last error: ",GetLastError());}
            //while(!BuyAsync(Lots,symbols[0])){Sleep(100);}
            longPos7_ = true;
         }
