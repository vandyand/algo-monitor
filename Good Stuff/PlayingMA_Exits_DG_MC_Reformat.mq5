...
input int ma_period17_1 = 2;
input int ma_period17_2 = 4;
input int ma_period17_3 = 2;
input int ma_period17_4 = 4;
input int ma_period17_5 = 2;
input int ma_period17_6 = 4;
input int ma_period17_7 = 2;
input int ma_period17_8 = 4;

input int ma_period18_1 = 2;
input int ma_period18_2 = 4;
input int ma_period18_3 = 2;
input int ma_period18_4 = 4;
input int ma_period18_5 = 2;
input int ma_period18_6 = 4;
input int ma_period18_7 = 2;
input int ma_period18_8 = 4;

input int ma_period19_1 = 2;
input int ma_period19_2 = 4;
input int ma_period19_3 = 2;
input int ma_period19_4 = 4;
input int ma_period19_5 = 2;
input int ma_period19_6 = 4;
input int ma_period19_7 = 2;
input int ma_period19_8 = 4;

input int ma_period20_1 = 2;
input int ma_period20_2 = 4;
input int ma_period20_3 = 2;
input int ma_period20_4 = 4;
input int ma_period20_5 = 2;
input int ma_period20_6 = 4;
input int ma_period20_7 = 2;
input int ma_period20_8 = 4;
...
int OnInit(){
   ...
   for(int i = 0; i < N; i++){
   maHandleX_1[i] = iMA(symbols[i],_Period,ma_periodX_1[i],0,MODE_SMA,PRICE_OPEN);
   maHandleX_2[i] = iMA(symbols[i],_Period,ma_periodX_2[i],0,MODE_SMA,PRICE_OPEN);
   maHandleX_3[i] = iMA(symbols[i],_Period,ma_periodX_3[i],0,MODE_SMA,PRICE_OPEN);
   maHandleX_4[i] = iMA(symbols[i],_Period,ma_periodX_4[i],0,MODE_SMA,PRICE_OPEN);
   maHandleX_5[i] = iMA(symbols[i],_Period,ma_periodX_5[i],0,MODE_SMA,PRICE_OPEN);
   maHandleX_6[i] = iMA(symbols[i],_Period,ma_periodX_6[i],0,MODE_SMA,PRICE_OPEN);
   maHandleX_7[i] = iMA(symbols[i],_Period,ma_periodX_7[i],0,MODE_SMA,PRICE_OPEN);
   maHandleX_8[i] = iMA(symbols[i],_Period,ma_periodX_8[i],0,MODE_SMA,PRICE_OPEN);
   }
