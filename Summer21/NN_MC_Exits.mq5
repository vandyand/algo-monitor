...
bool _longEnter, _longExit, _shortEnter, _shortExit, _neutral = false;
...
void OnTick()
{
   if(Find_New_Bar()){
      ...
      double node3_1 = activate("binary",node2_1 * nn_weight3_1_1 + node2_2 * nn_weight3_1_2 + node2_3 * nn_weight3_1_3 + node2_4 * nn_weight3_1_4);
      double node3_2 = activate("binary",node2_1 * nn_weight3_2_1 + node2_2 * nn_weight3_2_2 + node2_3 * nn_weight3_2_3 + node2_4 * nn_weight3_2_4);
      double node3_3 = activate("binary",node2_1 * nn_weight3_3_1 + node2_2 * nn_weight3_3_2 + node2_3 * nn_weight3_3_3 + node2_4 * nn_weight3_3_4);
      double node3_4 = activate("binary",node2_1 * nn_weight3_4_1 + node2_2 * nn_weight3_4_2 + node2_3 * nn_weight3_4_3 + node2_4 * nn_weight3_4_4);
/*      double node3_5 = activate("binary",node2_1 * nn_weight3_5_1 + node2_2 * nn_weight3_5_2 + node2_3 * nn_weight3_5_3 + node2_4 * nn_weight3_5_4);

      if(node3_1 > node3_2 && node3_1 > node3_3 && node3_1 > node3_4 && node3_1 > node3_5){
         _longEnter = true;
         _longExit = false;
         _shortEnter = false;
         _shortExit = false;
         _neutral = false;
      } else if(node3_2 > node3_1 && node3_2 > node3_3 && node3_2 > node3_4 && node3_2 > node3_5){
         _longEnter = false;
         _longExit = true;
         _shortEnter = false;
         _shortExit = false;
         _neutral = false;
      } else if(node3_3 > node3_1 && node3_3 > node3_2 && node3_3 > node3_4 && node3_3 > node3_5){
         _longEnter = false;
         _longExit = false;
         _shortEnter = true;
         _shortExit = false;
         _neutral = false;
      } else if(node3_4 > node3_1 && node3_4 > node3_2 && node3_4 > node3_3 && node3_4 > node3_5){
         _longEnter = false;
         _longExit = false;
         _shortEnter = false;
         _shortExit = true;
         _neutral = false;
      } else if(node3_5 > node3_1 && node3_5 > node3_2 && node3_5 > node3_3 && node3_5 > node3_4){
         _longEnter = false;
         _longExit = false;
         _shortEnter = false;
         _shortExit = false;
...
*/
      ...
      Print("nodes: ",node3_1, node3_2, node3_3, node3_4);
      Print("enters: ",_longEnter,_longExit,_shortEnter,_shortExit);
      int num_open = CurrentOpenPositions(magic1_);

      if(num_open > 0){
        if((longPos1 && _longExit && !_longEnter) || (shortPos1 && _shortExit && !_shortEnter)){
            CloseRecentPosition(magic1_);
            longPos1 = false;
            shortPos1 = false;
        }
      } else {
        if(_longEnter && !_longExit){
